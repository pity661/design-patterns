 ...
 * @description JDK的动态代理组成要素: 1,一个接口 2，一个接口实现类 3，一个代理类，实现了InvocationHandler接口
...
public class DynamicProxyTest {
  ...
  public static void main(String[] args) {
    ...
    DynamicProxyInterface dynamicProxyForImpl =
        (DynamicProxyInterface) dynamicProxy.dynamicBindImplToProxyClass(new DynamicProxyImpl());
