  ...
  public void listSort() {
    ...
    Comparator<Integer> comparator2 =
        Comparator.comparing(
            p -> p.intValue(), Comparator.nullsFirst(Integer::compareTo).reversed());
    list.sort(comparator2);

    list.stream().sorted(comparator);

    // 多个比较条件
    Comparator<Integer> comparator3 =
        Comparator.comparing(Integer::intValue).thenComparing(Integer::compareTo);
